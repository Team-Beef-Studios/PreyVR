...
idCVar pm_runpitch(					"pm_runpitch",				"0.0",		CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "" );
idCVar pm_runroll(					"pm_runroll",				"0.0",		CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "" );
idCVar pm_bobup(					"pm_bobup",					"0.0",		CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "" );
idCVar pm_bobpitch(					"pm_bobpitch",				"0.0",		CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "" );
idCVar pm_bobroll(					"pm_bobroll",				"0.0",		CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "" );
//Lubos END
...
idCVar vr_weaponToggle( 				"vr_weaponToggle", "1", CVAR_BOOL | CVAR_ARCHIVE, "VR weapon toggle.\n 0 = Up/Down\n 1 = Weapon wheel" );
