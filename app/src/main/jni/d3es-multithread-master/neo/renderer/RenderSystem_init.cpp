...
idCVar r_usePhong("r_usePhong", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_BOOL, "use phong instead of blinn-phong shader for interactions" );
...
idCVar r_skipBloomFX( "r_skipBloomFX", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "1 = don't render bloom FX" );
...
idCVar r_useOptimizedShadows( "r_useOptimizedShadows", "0", CVAR_RENDERER | CVAR_BOOL | CVAR_ARCHIVE, "use the dmap generated static shadow volumes" );
